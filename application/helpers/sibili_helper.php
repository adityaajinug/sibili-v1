...
function user_get()
{
  ...
  if ($ci->session->userdata('role_id') == 1) {
    ...
    $ci->template->load('templates/templates', 'dashboard_views/dosen', $data);
  }
}
function pa()
{
  ...
  if ($ci->session->userdata('role_id') == 1) {
    $ci->template->load('templates/templates', 'bimbingan/dosen', $data);
  } else if ($ci->session->userdata('role_id') == 2) {
    $ci->template->load('templates/templates', 'bimbingan/index', $data);
  } else if ($ci->session->userdata('role_id') == 3) {
    $ci->template->load('templates/templates', 'bimbingan/dosen', $data);
  }
}
function absensi()
{
  ...
  if ($ci->session->userdata('role_id') == 1) {
    $ci->template->load('templates/templates', 'absensi/absen_dosen', $data);
  } else if ($ci->session->userdata('role_id') == 2) {
    $ci->template->load('templates/templates', 'absensi/absen_mhs', $data);
  } else if ($ci->session->userdata('role_id') == 3) {
    $ci->template->load('templates/templates', 'absensi/absen_dosen', $data);
  }
}
