              ...
              <tbody>
                ...
                foreach ($th as $u) : ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('kaprodi/detail_th/' . $u['id_year']) ?>" class="badge badge-pill badge-success py-2 px-3"> Detail</a>
                      <a href="http://" class="badge badge-pill badge-warning py-2 px-3"> Edit</a>
