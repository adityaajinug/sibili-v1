      ...
      <div class="row text-center">
        ...
        <?php else : ?>
          <div class="col-md-6">
            ...
            <a href="#" data-toggle="modal" data-target="#edit-file" class="btn btn-success" style="border-radius: 10px;">Edit</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style="border-radius: 10px;">
      <div class="modal-body">
        ...
        <form action="<?= base_url('kki/laporan/tambah_koreksi') ?>" method="POST" class="pl-3 pr-3" enctype="multipart/form-data">
