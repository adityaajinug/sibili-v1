    ...
    if ($upload_form['limit_end'] <= $now) { ?>
      <div class="col-md">
        <div class="icon-none">
          ...
          <p>Saat ini belum bisa Unggah User Guide</p>
        </div>
      </div>
    <?php } else { ?>
      <div class="col-md">
              ...
              <table class="mt-4">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="ml-2">
                        <a href="<?= base_url('assets/file/user_guide/' . $upload['file']) ?>" target="_blank"> <?= word_limiter($upload['file'], 5);  ?>
                        </a>
                      </p>
                    </td>
...
$akhir = substr($nim, 9, 5);
echo $akhir;
$nidn = '0686.11.1995.070';
$akhirnidn = substr($nidn, 13, 3);
$tahun = substr($nidn, 8, 4);
echo '<br>';
$code = $tahun . '-' . $akhirnidn;
$hello  = "Hello World";
